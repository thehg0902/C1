...
- var(--token) only; zero hardcoded colors/sizes/durations (agency/contracts/design-tokens.md).
- Mobile-first: base styles are mobile; min-width media queries at 640/1024px.
- BEM-lite per agency/contracts/component-api.md. No !important except utilities.
