...
description: Install GA4 or Plausible per the Stack flag - consent-aware,
  performance-safe, with conversion events for calls/forms/bookings. Use in
  Phase 5 finishing. Not for SEO metadata (seo-technical).
...
## Inputs
Stack analytics flag + measurement ID / domain (absent -> QUESTIONS.md).
