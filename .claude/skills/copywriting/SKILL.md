...
metadata: {version: 1.0.0, category: content, tier: A}
---
# Copywriting
...
## Inputs
client.md (Business, Services, Audience, Mood, Testimonials, Special
requests), architecture in DECISIONS.md, niche playbook via design-direction
rationale.
...
6. Testimonials: verbatim from client.md only, trimmed with [...] allowed,
   never rewritten or fabricated.
