...
description: Implement contact/quote forms via Formspree - markup, validation,
  spam protection, success/error UX. Use when Stack forms:formspree in
...
## Inputs
Stack forms flag, Formspree endpoint (from client setup - if absent,
QUESTIONS.md: create form in Formspree dashboard, provide the ID).
